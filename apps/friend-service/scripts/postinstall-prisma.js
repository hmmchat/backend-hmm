...
// This matches the setup used in user-service and wallet-service
import fs from 'fs';
...
// Create symlink from @prisma/client to .prisma/client (like user-service)
try {
  fs.symlinkSync('../.prisma/client', prismaClientDir, 'dir');
  console.log('✅ Created @prisma/client symlink for friend-service');
} catch (error) {
