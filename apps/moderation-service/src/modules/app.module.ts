...
import { InternalUsersController } from "../routes/internal-users.controller.js";
...
@Module({
  ...
  controllers: [ModerationController, DareSubmissionController, KycController, KycAdminController, InternalUsersController, HealthController],
