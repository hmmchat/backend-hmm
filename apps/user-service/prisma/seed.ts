...
async function main() {
  ...
  const interests = [
    ...
    { name: "Photography", genre: "Creative" },
    { name: "Reading", genre: "Lifestyle" },
    { name: "Cooking", genre: "Lifestyle" },
    { name: "Gaming", genre: "Entertainment" },
    { name: "Movies", genre: "Entertainment" },
    { name: "Fitness", genre: "Sports" },
    { name: "Art", genre: "Creative" },
    { name: "Dancing", genre: "Creative" },
    { name: "Writing", genre: "Creative" },
    { name: "Technology", genre: "Tech" },
    { name: "Fashion", genre: "Creative" },
    { name: "Food", genre: "Lifestyle" },
    { name: "Nature", genre: "Travel" },
    { name: "Adventure", genre: "Travel" },
    { name: "Yoga", genre: "Sports" },
    { name: "Cycling", genre: "Sports" },
    { name: "Singing", genre: "Music" },
    { name: "Cricket", genre: "Sports" },
    { name: "Football", genre: "Sports" },
    { name: "Basketball", genre: "Sports" },
    { name: "Tennis", genre: "Sports" },
    { name: "Swimming", genre: "Sports" },
    { name: "Running", genre: "Sports" },
    { name: "Hiking", genre: "Sports" },
    { name: "Podcasts", genre: "Entertainment" },
    { name: "Standup", genre: "Entertainment" },
    { name: "Startups", genre: "Tech" },
    { name: "Coding", genre: "Tech" },
    { name: "Meditation", genre: "Wellness" },
    { name: "Skincare", genre: "Wellness" },
    { name: "Cars", genre: "Vehicles" },
    { name: "Bikes", genre: "Vehicles" },
    { name: "Dogs", genre: "Pets" },
    { name: "Cats", genre: "Pets" },
    { name: "Board games", genre: "Social" },
    { name: "Nightlife", genre: "Social" },
    { name: "Astronomy", genre: "Science" },
    { name: "Psychology", genre: "Science" }
  ];

  for (const interest of interests) {
    await prisma.interest.upsert({
      where: { name: interest.name },
      update: { genre: interest.genre },
      create: interest
    });
  }
