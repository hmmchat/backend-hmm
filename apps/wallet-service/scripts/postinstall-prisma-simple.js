#!/usr/bin/env node
// Simple postinstall script to create @prisma/client package.json for proper module resolution
import fs from 'fs';
...
console.log('✅ Created @prisma/client package.json for wallet-service');
