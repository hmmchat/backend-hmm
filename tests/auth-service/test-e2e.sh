...
if [ -z "$ACCESS_TOKEN" ] || [ -z "$REFRESH_TOKEN" ]; then
    ...
    echo "  1. Running ../../tests/auth-service/test-full-flow.sh (easiest - gets tokens from Google OAuth automatically)"
...
echo "  • To get new tokens easily, run: $SCRIPT_DIR/test-full-flow.sh"
